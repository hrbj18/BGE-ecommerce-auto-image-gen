...
export function promptSnapshotFromTask(task) {
  ...
  return {
    ...
    generationProfileId: String(task.generationProfileId || ""),
    imageAspectRatioProfileId: String(task.imageAspectRatioProfileId || ""),
    imageResolutionId: String(task.imageResolutionId || ""),
